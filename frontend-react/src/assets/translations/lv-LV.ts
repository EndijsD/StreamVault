...
export default {
  ...
  folders: 'Mapes',
  empty_search_title: 'Nekas netika atrasts',
  empty_search_description: 'Mēģiniet meklēt kaut ko citu.',
  empty_playlist_title: 'Šis atskaņošanas saraksts ir tukšs',
  empty_playlist_description: 'Pievienojiet šim sarakstam kādu mūziku.',
  empty_folder_title: 'Šī mape ir tukša',
